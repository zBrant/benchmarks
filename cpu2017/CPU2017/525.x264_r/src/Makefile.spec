...
commandexe       = x264_r_base.primeiro-teste-m64
...
log_line_width   = 1020
log_timestamp    = 0
logfile          = /home/kratos/specs/2017/tmp/CPU2017.002/templogs/preenv.intrate.002.2
logname          = /home/kratos/specs/2017/tmp/CPU2017.002/templogs/preenv.intrate.002.2
lognum           = 002.2
mail_reports     = all
mailcompress     = 0
mailmethod       = smtp
...
notes_plat_sysinfo_015 =  running on six-seven Sat Oct 11 18:48:56 2025
...
notes_plat_sysinfo_380 =    node 0 free: 651 MB
...
path             = /home/kratos/specs/2017/benchspec/CPU/525.x264_r
plain_train      = 1
platform         = 
power            = 0
...
review           = 0
run              = all
runcpu           = /home/kratos/specs/2017/bin/harness/runcpu --action buildsetup --noreportable --nopower --runmode rate --tune base --size refrate intrate --nopreenv --note-preenv --logfile /home/kratos/specs/2017/tmp/CPU2017.002/templogs/preenv.intrate.002.2 --lognum 002.2 --from_runcpu 2
rundir           = run
runmode          = rate
safe_eval        = 1
save_build_files = 
