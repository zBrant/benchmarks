...
BENCH_FLAGS      = -Ildecod_src/inc -Ix264_src -Ix264_src/extras -Ix264_src/common -DSPEC_AUTO_BYTEORDER=0x12345678
...
commandexe       = x264_s_base.primeiro-teste-m64
...
log_line_width   = 1020
log_timestamp    = 0
logfile          = /home/kratos/specs/2017/tmp/CPU2017.002/templogs/preenv.intspeed.002.3
logname          = /home/kratos/specs/2017/tmp/CPU2017.002/templogs/preenv.intspeed.002.3
lognum           = 002.3
mail_reports     = all
mailcompress     = 0
mailmethod       = smtp
...
notes_plat_sysinfo_015 =  running on six-seven Sat Oct 11 18:49:00 2025
...
notes_plat_sysinfo_380 =    node 0 free: 515 MB
...
notes_plat_sysinfo_655 =     /dev/sda2      ext4   98G   32G   61G  35% /
...
path             = /home/kratos/specs/2017/benchspec/CPU/625.x264_s
plain_train      = 1
platform         = 
power            = 0
...
review           = 0
run              = all
runcpu           = /home/kratos/specs/2017/bin/harness/runcpu --action buildsetup --noreportable --nopower --runmode speed --tune base --size refspeed intspeed --nopreenv --note-preenv --logfile /home/kratos/specs/2017/tmp/CPU2017.002/templogs/preenv.intspeed.002.3 --lognum 002.3 --from_runcpu 2
rundir           = run
runmode          = speed
safe_eval        = 1
save_build_files = 
...
srcalt           = 
srcdir           = src
srcsource        = /home/kratos/specs/2017/benchspec/CPU/525.x264_r/src
stagger          = 10
