...
commandexe       = omnetpp_s_base.primeiro-teste-m64
...
log_line_width   = 1020
log_timestamp    = 0
logfile          = /home/kratos/cpu2017/tmp/CPU2017.008/templogs/preenv.intspeed.008.3
logname          = /home/kratos/cpu2017/tmp/CPU2017.008/templogs/preenv.intspeed.008.3
lognum           = 008.3
mail_reports     = all
mailcompress     = 0
mailmethod       = smtp
...
notes_plat_sysinfo_015 =  running on watter Sat Sep 27 22:21:34 2025
...
path             = /home/kratos/cpu2017/benchspec/CPU/620.omnetpp_s
plain_train      = 1
platform         = 
power            = 0
...
review           = 0
run              = all
runcpu           = /home/kratos/cpu2017/bin/harness/runcpu --configfile my-first-run.cfg --action build --fake --noreportable --nopower --runmode speed --tune base --size refspeed intspeed --nopreenv --note-preenv --logfile /home/kratos/cpu2017/tmp/CPU2017.008/templogs/preenv.intspeed.008.3 --lognum 008.3 --from_runcpu 2
rundir           = run
runmode          = speed
safe_eval        = 1
save_build_files = 
...
srcalt           = 
srcdir           = src
srcsource        = /home/kratos/cpu2017/benchspec/CPU/520.omnetpp_r/src
stagger          = 10
